        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad sobre “Seguimiento, auditoría y mejora continua de la seguridad vial laboral” forma a profesionales en la gestión efectiva del PESV. Aborda el seguimiento de indicadores claves (KPIs), la elaboración de informes, la ejecución de auditorías internas, y la implementación de acciones correctivas y preventivas. Resalta la necesidad de una cultura organizacional basada en la prevención, la participación activa, y la integración con otros sistemas de gestión (ISO 39001, 45001 y 14001). Este enfoque integral fortalece la seguridad vial, reduce riesgos y promueve la sostenibilidad en el entorno laboral.
